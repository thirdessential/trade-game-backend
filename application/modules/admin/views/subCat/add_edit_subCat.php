        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <form role="form" class="form-vertical" id="newsForm" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/subCat/save_subCat/<?php
                                ...
                                <div class="box-body">
                                   ...
                                   <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label for="tilte">Select Category</label>
