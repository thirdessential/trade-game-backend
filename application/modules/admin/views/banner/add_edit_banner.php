        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    ...
                    <form role="form" class="form-vertical" id="newsForm" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/banner/save_banner/<?php
...
<?php
                                                 if (!empty($news_info->category_id)) {
                                                   ...
                                                   <?php if (!empty($all_category)): foreach ($all_category as $v_cat) : 
                                                       if ($v_cat->id==$news_info->category_id) {
                                                         ?>
...
<?php
                                                 if (!empty($news_info->album_id)) {

                                                   ?>
                                                   <?php if (!empty($all_album)): foreach ($all_album as $v_cat) : 
                                                       if ($v_cat->id==$news_info->album_id) {
                                                         ?>
