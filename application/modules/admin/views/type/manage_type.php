                            ...
                            <?php if (!empty($all_album)): foreach ($all_album as $v_user) : ?>
                                    <tr>
                                       ...
                                       <td class="text-center"> <?php echo $v_user->title;  ?></td>
                                        ...
                                        <td>
                                            <?php echo btn_edit('admin/type/edit_type/' . $v_user->id); ?>
                                        
                                           <a class="btn btn-danger btn-xs" onclick="deleteData('admin/type/delete_type/<?php echo $v_user->id; ?>')"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php
