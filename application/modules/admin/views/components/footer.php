<!-- /.content-wrapper -->
 ...
 <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date("Y") ?> <a href="<?php echo base_url() . 'admin'; ?>">Trade Game </a>. </strong>&nbsp; All rights
    reserved.
...
<script src="<?php echo base_url(); ?>assets/admin/dateTime/js/bootstrap-datetimepicker.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/dateTime/js/bootstrap-datetimepicker.min.js"></script>
...
<script src="<?php echo base_url(); ?>assets/admin/fancy-box/jquery.fancybox.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/fancy-box/jquery.fancybox.pack.js"></script>
