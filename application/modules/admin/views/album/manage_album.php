            ...
            <div class="box box-primary box-solid">
                <div class="box-header box-header-background with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url(); ?>admin/album/edit_album" class="btn btn-warning">Add New</a>
                    </div>
                </div>
                <!-- /.box-header -->
                            ...
                            <?php if (!empty($all_album)): foreach ($all_album as $v_user) : ?>
                                    <tr>
                                       ...
                                       <td class="text-center"> <?php echo $v_user->title;  ?></td>
                                        ...
                                        <td>
                                            <?php echo btn_edit('admin/album/edit_album/' . $v_user->id); ?>
                                         <a class="btn btn-danger btn-xs" onclick="deleteData('admin/album/delete_album/<?php echo $v_user->id; ?>')"><i class="fa fa-trash-o"></i></a>
