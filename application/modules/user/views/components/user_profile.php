...
<header class="main-header">
    ...
    <a href="<?php echo base_url() ?>user" class="logo">
        ...
        <!-- <span class="logo-lg"><img src="http://youritteam.co.in/signet/assets/uploads/images/placeholder.png" style="
        height: 42px;
        "></span> -->
        <span class="logo-lg abc"><b>Sahara</b>One</span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo base_url() ?>user/edit_profile" class="btn btn-default btn-flat">Profile</a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo base_url() ?>user/login/logout" class="btn btn-default btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
