...
<body class="login-page">
    ...
    <div class="login-box">
        <div class="login-logo animated fadeInDown" data-animation="fadeInDown">
            <a href="<?php echo base_url() . 'admin'; ?>" class="logo"><img src="<?php echo base_url() . 'assets/uploads/images/placeholder.png' ?>" height="150" class="img-responsive" style="display:inline-block" alt="User Image" /></a>
        </div><!-- /.login-logo -->
