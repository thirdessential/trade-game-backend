                    ...
                    <table id="dataTables-example" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="active text-center">Transfer User</th>
                        ...
                        <tbody>
                            <?php $i = 1 ?>
                            <?php if (!empty($transfer_pin_detail)): foreach ($transfer_pin_detail as $v_pin) : ?>
                                    <tr>
                                        <td class="text-center"><?php echo $i ?></td>
                                        <td class="text-center"> <?php echo $v_pin->pin_value;  ?></td>
                                        <td class="text-center"> <?php echo $v_pin->transfer_userId .' ['. $v_pin->transfer_user_name. ']'  ?></td>
