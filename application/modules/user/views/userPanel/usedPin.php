                    ...
                    <table id="dataTables-example" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="active text-center">Activate User</th>
                        ...
                        <tbody>
                            <?php $i = 1 ?>
                            <?php if (!empty($used_pin)): foreach ($used_pin as $v_pin) : ?>
                                    <tr>
                                        <td class="text-center"><?php echo $i ?></td>
                                        <td class="text-center"> <?php echo $v_pin->pin_value;  ?></td>
                                        <td class="text-center"> <?php echo $v_pin->activate_userId .' ['. $v_pin->activate_user_name. ']'  ?></td>
