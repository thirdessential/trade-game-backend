    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                    <!-- form start -->
                    <form role="form" class="form-vertical" id="bankForm" enctype="multipart/form-data" autocomplete="off" action="<?php echo base_url(); ?>user/bank/save_bank/<?php
                    ...
                    ?>" method="post">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="box-body">
                                    <input type="hidden" id="bankId" value="<?php echo (!empty($bank_info->id)) ? ($bank_info->id) : ('') ?>">
                                    <div class="row">
